...
class Expectation:
    ...
    check: str
    threshold: float = 0.0
    compare_pair: tuple[int, int] | None = None  # для 'greater_than'
    description: str = ""
